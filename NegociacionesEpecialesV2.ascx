...
<%@ control language="VB" autoeventwireup="false" inherits="NegociacionesEpecialesV2, App_Web_qiaq133f" %>
                                                                    ...
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: right">
                                                                                ...
                                                                                <asp:TextBox ID="TxtDescuentoCapturado" runat="server" MaxLength="2" BackColor="Red" ForeColor="White" Width="40"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
