<%@ control language="VB" autoeventwireup="false" inherits="Estilos_InformacionAdicional, App_Web_qiaq133f" %>
                    ...
                    <asp:UpdatePanel runat="server" ID="UpnlOpcionesAdd">
                        <ContentTemplate>
                            <table class="Table">
                                <tr>
                                    <td>
                                        <asp:Button ID="BtnAgregarTelefonos" runat="server" CssClass="Botones" Text="Agregar Teléfono" Visible="false" /></td>
                                    <td>
                                        <asp:Button ID="BtnAgregarDirecciones" runat="server" CssClass="Botones" Text="Agregar Dirección" Visible="false" /></td>
                                    <td>
                                        <asp:Button ID="BtnAgregarCorreos" runat="server" CssClass="Botones" Text="Agregar Correo"  Visible="false"/></td>
                                </tr>
                            </table>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                                ...
                                <tr align="center">
                                    <td>
                                        <table class="Izquierda">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="LblHist_Ge_Accion_Te" runat="server" CssClass="LblDesc" Text="Acción" Visible="False"></asp:Label></td>
                                                <td colspan="3">
                                                    <asp:DropDownList ID="DdlHist_Ge_Accion_Te" runat="server" CssClass="DdlDesc" Visible="False" >
                                                        <asp:ListItem Selected="True">Seleccione</asp:ListItem>
                                                        <asp:ListItem Value="GT">Gestión telefónica</asp:ListItem>
                                                        <asp:ListItem Value="IN">Llamada de entrada</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                                <td rowspan="8" class="Arriba">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <asp:TextBox ID="TxtHist_Te_Lada" runat="server" MaxLength="3" Width="40"></asp:TextBox>
                                                      <asp:FilteredTextBoxExtender ID="FtbTxtHist_Te_Lada" runat="server" Enabled="True" TargetControlID="TxtHist_Te_Lada" ValidChars="1234567890">
                                                           </asp:FilteredTextBoxExtender>
                                                    &#160;&#160;&#160;
                                                                                                <asp:Label ID="LblHist_Te_Numerotel" runat="server" CssClass="LblDesc" Text="Teléfono"></asp:Label>&#160;&#160;<asp:TextBox ID="TxtHist_Te_Numerotel" runat="server" MaxLength="8" Width="100"></asp:TextBox>
                                                     <asp:FilteredTextBoxExtender ID="FtbTxtHist_Te_Numerotel" runat="server" Enabled="True" TargetControlID="TxtHist_Te_Numerotel" ValidChars="1234567890">
                                                                                </asp:FilteredTextBoxExtender>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <tr align="center">
                                    <td>
                                        <table class="Izquierda">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="LblHist_Ge_Accion_Co" runat="server" CssClass="LblDesc" Text="Acción" Visible="False"></asp:Label>
                                                </td>
                                                <td colspan="3">
                                                    <asp:DropDownList ID="DdlHist_Ge_Accion_Co" runat="server" CssClass="DdlDesc" Visible="False">
                                                         <asp:ListItem Selected="True">Seleccione</asp:ListItem>
                                                        <asp:ListItem Value="GT">Gestión telefónica</asp:ListItem>
                                                        <asp:ListItem Value="IN">Llamada de entrada</asp:ListItem>
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <asp:TextBox ID="TxtHist_Co_Correo" runat="server" MaxLength="100" Width="200px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TxtHist_Co_Nombre" runat="server" MaxLength="99" Visible="False" Width="200px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td>
