<%@ control language="VB" autoeventwireup="false" inherits="Negociaciones, App_Web_qiaq133f" %>
                                ...
                                <td>
                                    <asp:Panel runat="server" ID="PnlFechas" Visible="false">
                                        <table class="Table">
                                                                                ...
                                                                                <asp:Panel ID="PnlPagoUnico" runat="server" Visible="false">
                                                                                    <table>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:TextBox ID="TxtFechaPagoInicialU" runat="server" CssClass="TxtDesc" Width="80px" Enabled="False"></asp:TextBox>

                                                                                                <asp:CalendarExtender ID="TxtFechaPagoInicialU_CalendarExtender" runat="server" CssClass="Calendario" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="ImgFechaPagoInicialU" TargetControlID="TxtFechaPagoInicialU">
                                                                                                </asp:CalendarExtender>
                                                                                            </td>
                                                                                            <td>
                                                                                                <asp:Image ID="ImgFechaPagoInicialU" runat="server" ImageUrl="Imagenes/ImgCalendario.png" />
                                                                                            </td>
                                                                                            <td>&nbsp;</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:TextBox ID="TxtFechaPagoU" runat="server" CssClass="TxtDesc" Width="80px" Enabled="False"></asp:TextBox>
                                                                                                <asp:CalendarExtender ID="TxtFechaPagoU_CalendarExtender" runat="server" CssClass="Calendario" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="ImgFechaPagoU" TargetControlID="TxtFechaPagoU">
                                                                                                </asp:CalendarExtender>
                                                                                            </td>
                                                                                            <td>
                                                                                                <asp:Image ID="ImgFechaPagoU" runat="server" ImageUrl="Imagenes/ImgCalendario.png" />
                                                                                            </td>
                                                                                            <td>
                                                                                            ...
                                                                                            <td>
                                                                                                <table>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="TxtFechaInicialPay" runat="server" CssClass="TxtDesc" Width="80px" Enabled="False"></asp:TextBox>
                                                                                                            <asp:CalendarExtender ID="CETxtFechaInicialPay" runat="server" CssClass="Calendario" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="ImgFechaInicialPay" TargetControlID="TxtFechaInicialPay">
                                                                                                            </asp:CalendarExtender>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <asp:Image ID="ImgFechaInicialPay" runat="server" ImageUrl="Imagenes/ImgCalendario.png" />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="TxtFechaMenPay" runat="server" CssClass="TxtDesc" Width="80px" Enabled="False"></asp:TextBox>

                                                                                                            <asp:CalendarExtender ID="CETxtFechaMenPay" runat="server" CssClass="Calendario" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="ImgFechaMenPay" TargetControlID="TxtFechaMenPay">
                                                                                                            </asp:CalendarExtender>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <asp:Image ID="ImgFechaMenPay" runat="server" ImageUrl="Imagenes/ImgCalendario.png" />
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:Panel ID="Pnl12Meses" runat="server" Visible="false">
                                                        <table>
                                                            <tr>
                                                                <td colspan="3">
                                                                    <asp:Label ID="LblFechaMax0" runat="server" CssClass="LblDesc"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="LblEtiquetaNego0" runat="server" CssClass="LblDesc"></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr class="LblDesc">
                                                                <td colspan="3">El saldo Negociado no puede ser menor a:</td>
                                                                <td>
                                                                    <asp:Label ID="LblMinSaldoNego2" runat="server" ForeColor="#006600"></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="LblCat_Ne_Num_Pagos0" runat="server" CssClass="LblDesc" Text="Número De Pagos"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:DropDownList ID="DdlCat_Ne_Num_Pagos0" runat="server" AutoPostBack="true">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td>
                                                                    <asp:Image ID="Img13" runat="server" ImageUrl="~/Imagenes/ImgNumber1.png" />
                                                                </td>
                                                                <td>&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2">
                                                                    <asp:Label ID="LblSaldoNegociado2" runat="server" CssClass="LblDesc" Text="Negociar Por"></asp:Label>
                                                                    <asp:Image ID="Img14" runat="server" ImageUrl="~/Imagenes/ImgNumber2.png" />
                                                                </td>
                                                                <td colspan="2">
                                                                    <asp:RadioButtonList ID="RblTipo0" runat="server" AutoPostBack="true" CssClass="RblDesc" RepeatDirection="Horizontal">
                                                                        <asp:ListItem Selected="True">Seleccione</asp:ListItem>
                                                                        <asp:ListItem>Saldo</asp:ListItem>
                                                                        <asp:ListItem>Descuento</asp:ListItem>
                                                                    </asp:RadioButtonList>
                                                            ...
                                                            <tr>
                                                                <td>&nbsp;</td>
                                                                <td>
                                                                    <asp:Label ID="LblSaldoNegociado3" runat="server" CssClass="LblDesc" Visible="False"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="TxtSaldoNegociado0" runat="server" AutoPostBack="True" CssClass="TxtDesc" MaxLength="20" Visible="false"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="TxtSaldoNegociado0_FilteredTextBoxExtender" runat="server" Enabled="True" TargetControlID="TxtSaldoNegociado0" ValidChars="1234567890.">
                                                                    </asp:FilteredTextBoxExtender>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="LblMinSaldoNego1" runat="server" ForeColor="#006600"></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="LblPagoInicial12" runat="server" CssClass="LblDesc" Text="Pago Inicial"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="TxtPagoInicial12" runat="server" CssClass="TxtDesc" Width="80px"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="TxtPagoInicial12_FilteredTextBoxExtender" runat="server" Enabled="True" TargetControlID="TxtPagoInicial12" ValidChars="1234567890.">
                                                                    </asp:FilteredTextBoxExtender>
                                                                </td>
                                                                <td>
                                                                    <asp:Image ID="Image9" runat="server" ImageUrl="~/Imagenes/ImgNumber3.png" />
                                                                </td>
                                                                <td>&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="LblFechaPagoInicial12" runat="server" CssClass="LblDesc" Text="Fecha Pago Inicial"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="TxtFechaPagoInicial12" runat="server" CssClass="TxtDesc" Enabled="False" Width="80px"></asp:TextBox>
                                                                    <asp:CalendarExtender ID="TxtFechaPagoInicial12_CalendarExtender" runat="server" CssClass="Calendario" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="ImgFechaPagoInicial12" TargetControlID="TxtFechaPagoInicial12">
                                                                    </asp:CalendarExtender>
                                                                </td>
                                                                <td>
                                                                    <asp:Image ID="ImgFechaPagoInicial12" runat="server" ImageUrl="Imagenes/ImgCalendario.png" />
                                                                </td>
                                                                <td>
                                                                    <asp:Image ID="Img12" runat="server" ImageUrl="~/Imagenes/ImgNumber4.png" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="LblMontoPagos12" runat="server" CssClass="LblDesc" Text="Monto De Pago"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="TxtMontoPagos12" runat="server" Width="80px"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="TxtMontoPagos12_FilteredTextBoxExtender" runat="server" Enabled="True" TargetControlID="TxtMontoPagos12" ValidChars="1234567890.">
                                                                    </asp:FilteredTextBoxExtender>
                                                                </td>
                                                                <td>&nbsp;</td>
                                                                <td>&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="LblFechaPago12" runat="server" CssClass="LblDesc" Text="Fecha De Pago"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="TxtFechaPago12" runat="server" CssClass="TxtDesc" Enabled="False" Width="80px"></asp:TextBox>
                                                                    <asp:CalendarExtender ID="TxtFechaPago12_CalendarExtender" runat="server" CssClass="Calendario" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="ImgFechaPago12" TargetControlID="TxtFechaPago12">
                                                                    </asp:CalendarExtender>
                                                                </td>
                                                                <td>
                                                                    <asp:Image ID="ImgFechaPago12" runat="server" ImageUrl="Imagenes/ImgCalendario.png" />
                                                                </td>
                                                                <td>
                                                                    <asp:Image ID="Image8" runat="server" ImageUrl="~/Imagenes/ImgNumber5.png" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </asp:Panel>
                                                        ...
                                                        <tr>
                                                            <td class="Arriba">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="LblEnviarDdv" runat="server" CssClass="LblDesc" Text="¿Enviar DDV?"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:DropDownList ID="DdlEnviarDdv" runat="server" AutoPostBack="True" CssClass="TxtDesNS">
                                                                                <asp:ListItem Selected="True">Seleccione</asp:ListItem>
                                                                                <asp:ListItem>Si</asp:ListItem>
                                                                                <asp:ListItem>No</asp:ListItem>
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td><%--&nbsp;&nbsp;&nbsp;<asp:RadioButtonList ID="RblIn" runat="server" Visible="false" CssClass="RblDesc" RepeatDirection="Horizontal">
                                                                            <asp:ListItem Selected="True">Seleccione</asp:ListItem>
                                                                            <asp:ListItem Value="IN">Entrada</asp:ListItem>
                                                                            <asp:ListItem Value="GT">Salida</asp:ListItem>
                                                                        </asp:RadioButtonList>--%>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="RblHist_Ge_Inoutbound" runat="server" AutoPostBack="true" CssClass="RblDesc">
                                                                                <asp:ListItem Selected="True">Seleccione</asp:ListItem>
                                                                                        ...
                                                                                        <table style="border-style: hidden; text-align: left">
                                                                                            <tr style="border-style: hidden;">
                                                                                                <td style="vertical-align: top; border-style: hidden">
                                                                                                    <asp:ImageButton Visible="false" ID="ImgValido" runat="server" ImageUrl="~/Imagenes/ImgValido.png" OnClick="ImgValido_Click" />
                                                                                                </td>
                                                                                                <td style="vertical-align: top; border-style: hidden">&nbsp;</td>
                                                                                                <td style="vertical-align: top; border-style: hidden">
                                                                                                    <asp:ImageButton Visible="false" ID="ImgNoValido" runat="server" ImageUrl="~/Imagenes/ImgNoValido.png" OnClick="ImgValido_Click" />
                                                                                                </td>
                                                                                                <td style="vertical-align: top; border-style: hidden">&nbsp;</td>
                                                                                                <td style="vertical-align: top; border-style: hidden">
...
<asp:Panel ID="PnlModalAceptar" runat="server" CssClass="ModalAcciones">
    <%--Style="display: none">--%>
    <table class="Table">
        <tr class="heading">
            <td>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="TxtUsuarioA" runat="server" CssClass="TxtDesc" Width="130px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtContrasenaA" runat="server" TextMode="Password" Width="130px"></asp:TextBox>
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="BtnAceptarAceptar" runat="server" CssClass="button green close" Text="Aceptar" OnClientClick="clicTwice(this, 'Procesando...')" UseSubmitBehavior="false" ValidationGroup="Procesar" />
                        </td>
                        <td>
