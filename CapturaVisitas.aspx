<%@ page language="VB" autoeventwireup="false" inherits="CapturaVisitas, App_Web_z3ahlyik" uiculture="es" culture="es-MX" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="NegociacionesvISITAS.ascx" TagName="GNegociaciones" TagPrefix="MPCU8" %>
<!DOCTYPE html>
                                ...
                                <asp:UpdatePanel runat="server" ID="UpnlVisita" Visible="false">
                                    <ContentTemplate>
                                        ...
                                        <table class="Izquierda">
                                                    ...
                                                    <asp:Panel ID="Pnlgestion" runat="server" CssClass="collapsePanel">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table class="Izquierda" style="visibility: hidden">
                                                                        <tr>
                                                                            <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:TabContainer ID="TCM" runat="server" ActiveTabIndex="0" Width="100%">
                                                                    ...
                                                                    <tr class="Arriba">
                                                                        <td>
                                                                            <table>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:Label ID="LblZona" runat="server" CssClass="LblDesc" Text="Zona" Visible="False"></asp:Label>
                                                                                    </td>
                                                                                    <td colspan="3">
                                                                                        <asp:DropDownList ID="DdlZona" runat="server" CssClass="TxtDesNS" Visible="False">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td colspan="3">
                                                                                        <asp:TextBox ID="TxtHist_Vi_Dtevisita" runat="server" Enabled="false"></asp:TextBox>
                                                                                        <asp:CalendarExtender ID="TxtHist_Vi_Dtevisita_CalendarExtender" runat="server" Enabled="True" PopupButtonID="ImgHist_Vi_Dtevisita" TargetControlID="TxtHist_Vi_Dtevisita" Format="dd/MM/yyyy">
                                                                                        </asp:CalendarExtender>
                                                                                        &nbsp;<asp:Image ID="ImgHist_Vi_Dtevisita" runat="server" ImageUrl="Imagenes/ImgCalendario.png" />
                                                                                        &nbsp;<asp:TextBox ID="TxtHist_Vi_Dtevisita2" runat="server" Width="50px"></asp:TextBox>
                                                                                        <asp:MaskedEditExtender ID="TxtHist_Vi_Dtevisita2MEE" runat="server" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" ErrorTooltipEnabled="True" InputDirection="RightToLeft" Mask="99:99" MaskType="Time" TargetControlID="TxtHist_Vi_Dtevisita2">
                                                                                        </asp:MaskedEditExtender>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:Label ID="LblAcuerdo" runat="server" CssClass="LblDesc" Text="Tipo De Acuerdo" Visible="False"></asp:Label>
                                                                                    </td>
                                                                                    <td colspan="3">
                                                                                        <asp:DropDownList ID="DdlAcuerdo" runat="server" AutoPostBack="True" CssClass="DdlDesc" Visible="False">
                                                                                            <asp:ListItem Selected="True">Seleccione</asp:ListItem>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:Label ID="LblAcuerdoMto1" runat="server" CssClass="LblDesc" Text="Monto De Acuerdo" Visible="False"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="TxtAcuerdoMto1" runat="server" MaxLength="10" Visible="False"></asp:TextBox>
                                                                                        <asp:FilteredTextBoxExtender ID="TxtAcuerdoMto1_FilteredTextBoxExtender" runat="server" Enabled="True" TargetControlID="TxtAcuerdoMto1" ValidChars="1234567890.">
                                                                                        </asp:FilteredTextBoxExtender>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="LblAcuerdoDte1" runat="server" CssClass="LblDesc" Text="Vigencia De Acuerdo" Visible="False"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="TxtAcuerdoDte1" runat="server" CssClass="TxtDesc" Enabled="False" Width="103px" Visible="False"></asp:TextBox>
                                                                                        <asp:CalendarExtender ID="TxtAcuerdoDte1_CalendarExtender" runat="server" CssClass="Calendario" Enabled="True" Format="ddMMyy" PopupButtonID="ImgAcuerdoDte1" TargetControlID="TxtAcuerdoDte1">
                                                                                        </asp:CalendarExtender>
                                                                                        <asp:Image ID="ImgAcuerdoDte1" runat="server" ImageUrl="Imagenes/ImgCalendario.png" Visible="False" />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:Label ID="LblAcuerdoMto2" runat="server" CssClass="LblDesc" Text="Monto De Acuerdo" Visible="False"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="TxtAcuerdoMto2" runat="server" MaxLength="10" Visible="False"></asp:TextBox>
                                                                                        <asp:FilteredTextBoxExtender ID="TxtAcuerdoMto2_FilteredTextBoxExtender" runat="server" Enabled="True" TargetControlID="TxtAcuerdoMto2" ValidChars="1234567890.">
                                                                                        </asp:FilteredTextBoxExtender>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="LblAcuerdoDte2" runat="server" CssClass="LblDesc" Text="Vigencia De Acuerdo" Visible="False"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="TxtAcuerdoDte2" runat="server" CssClass="TxtDesc" Enabled="False" Width="103px" Visible="False"></asp:TextBox>
                                                                                        <asp:CalendarExtender ID="TxtAcuerdoDte2_CalendarExtender" runat="server" CssClass="Calendario" Enabled="True" Format="ddMMyy" PopupButtonID="ImgAcuerdoDte2" TargetControlID="TxtAcuerdoDte2">
                                                                                        </asp:CalendarExtender>
                                                                                        <asp:Image ID="ImgAcuerdoDte2" runat="server" ImageUrl="Imagenes/ImgCalendario.png" Visible="False" />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td></td>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:TextBox ID="TxtHist_Pr_Montopp" runat="server" MaxLength="10" Visible="False"></asp:TextBox>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:Label ID="LblHist_Vi_Parentesco" runat="server" CssClass="LblDesc" Text="Parentesco" Visible="False"></asp:Label>
                                                                                    </td>
                                                                                    <td colspan="3">
                                                                                        <asp:DropDownList ID="DdlHist_Vi_Parentesco" runat="server" AutoPostBack="True" CssClass="DdlDesc" Visible="False">
                                                                                        </asp:DropDownList>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                        ...
                                                                        <td>
                                                                            <table>
                                                                                <tr class="Arriba">
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:GridView ID="GvDiasVisita" runat="server" CssClass="mGrid" Font-Names="Tahoma" Font-Size="Small">
                                                                                ...
                                                                                <tr class="Arriba">
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:MaskedEditExtender ID="TxtHist_Vi_HcontactoMEE" runat="server"
                                                                                            ErrorTooltipEnabled="True" InputDirection="RightToLeft" Mask="99:99" MaskType="Time"
                                                                                            TargetControlID="TxtHist_Vi_Hcontacto" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True">
                                                                                        </asp:MaskedEditExtender>
                                                                                        ...
                                                                                        <asp:MaskedEditExtender ID="TxtHist_Vi_Hcontacto0MEE" runat="server"
                                                                                            ErrorTooltipEnabled="True" InputDirection="RightToLeft" Mask="99:99" MaskType="Time"
                                                                                            TargetControlID="TxtHist_Vi_Hcontacto0" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True">
                                                                                        </asp:MaskedEditExtender>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
